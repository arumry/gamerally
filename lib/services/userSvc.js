...
module.exports.getCounterCheck = function(id){
	return User.findAsync({'_id': id}, ['countercheck']);
};
...
module.exports.getUserByID = function(id){
	return User.findAsync({'_id': id}, ['steamid', 'displayname', 'profileurl', 'avatar', 'type', 'bio']);
};

module.exports.getUserIDBySteamID = function(steamid){
	return User.findAsync({'steamid': steamid}, ['_id']);
};

//Mail services
module.exports.getInbox = function(id){
	return User.findAsync({'_id': id}, ['inbox']);
};
...
module.exports.getGames = function(id){
	return User.findAsync({'_id': id}, ['games'])
};
...
module.exports.getPendingFriends = function(id){
	return User.getPendingFriendsAsync(id);
};

module.exports.getAcceptedFriends = function(id){
	return User.getAcceptedFriendsAsync(id);
};

module.exports.getRequestedFriends = function(id){
	return User.getRequestedFriendsAsync(id);
};
