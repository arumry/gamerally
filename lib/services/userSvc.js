...
module.exports.getPendingFriends = function(id){
	return User.getPendingFriendsAsync(id, {}, '-countercheck -inbox -steamid');
};

module.exports.getAcceptedFriends = function(id){
	return User.getAcceptedFriendsAsync(id, {}, '-countercheck -inbox -steamid');
};

module.exports.getRequestedFriends = function(id){
	return User.getRequestedFriendsAsync(id, {}, '-countercheck -inbox -steamid');
};
